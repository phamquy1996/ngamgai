                ...
                <div class="card-body">
                    <table id="bootstrap-data-table" class="table table-striped table-bordered">
                        ...
                        @foreach($subphu as $item)
                            <tr>
                                <td>{{$item->name}}</td>
                                <td>{{$item->subcate->name}}</td>
                                <td>
                                    <a href="quantri/subphu/edit/{{ $item->id }}" title="Sửa"><i class="fa fa-edit"></i></a>
                                    <a href="quantri/subphu/delete/{{ $item->id }}" title="Xóa"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
